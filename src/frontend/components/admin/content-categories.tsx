        ...
        {categories.map((category) => (
          ...
          >
            <div className="flex items-center space-x-3 flex-1 min-w-0">
              <span className={`px-2 py-1 text-xs rounded-full font-medium ${category.color} flex-shrink-0`}>
                {category.name}
              </span>
            ...
            <div className="flex items-center space-x-2 flex-shrink-0">
              <div className="text-right">
                ...
                <div className="flex items-center justify-end">
                  ...
                  <span
                    className={`text-xs ${category.change > 0 ? 'text-green-600' : 'text-red-600'}`}
                  >
                    {category.change > 0 ? '+' : ''}
                    {category.change}%
                  </span>
